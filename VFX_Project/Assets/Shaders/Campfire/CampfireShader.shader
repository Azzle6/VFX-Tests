...
Shader "CampfireShader"
{
	Properties
	{
		...
		_BaseFlameHeight("Base Flame Height", Range( 0 , 1)) = 0.35
		_MainFlameHeight("Main Flame Height", Range( 0 , 1)) = 0.75
	...
	SubShader
	{
		...
		uniform float _BaseFlameHeight;
		...
		uniform float _MainFlameHeight;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float smoothstepResult165 = smoothstep( ( 1.0 - _BaseFlameHeight ) , 1.0 , lerpResult89);
			...
			float smoothstepResult19 = smoothstep( ( 1.0 - _MainFlameHeight ) , 0.7 , lerpResult11);
...
Node;AmplifyShaderEditor.CommentaryNode;171;-1318.93,-1011.634;Inherit;False;1734.221;858.5688;Color management;6;17;164;172;165;91;89;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;17;-560.9045,-922.6995;Inherit;False;Property;_MidFlamesColor;MidFlamesColor;6;1;[HDR];Create;True;0;0;0;False;0;False;1.498039,0.4171922,0.06441575,0;1,0.8348083,0.07800001,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;164;-562.3832,-732.1037;Inherit;False;Property;_OriginZoneColor;OriginZoneColor;5;1;[HDR];Create;True;0;0;0;False;0;False;4.541206,2.419898,0.3224255,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SmoothstepOpNode;90;-729.8184,-1244.511;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.3;False;2;FLOAT;0.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;165;-543.6541,-436.9944;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.65;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;19;-637.5625,240.8353;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.25;False;2;FLOAT;0.7;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;194;-718.3083,-137.5977;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;193;-1015.845,-138.2045;Inherit;False;Property;_BaseFlameHeight;Base Flame Height;10;0;Create;True;0;0;0;False;0;False;0.35;0.35;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;182;-1793.234,432.2215;Inherit;True;Property;_CausticTexture;Caustic Texture;0;0;Create;True;0;0;0;False;0;False;d7be84cbf4e328a4fb89ee5db3add904;d7be84cbf4e328a4fb89ee5db3add904;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.OneMinusNode;195;-732.742,98.34975;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;196;-1030.279,97.74296;Inherit;False;Property;_MainFlameHeight;Main Flame Height;11;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;91;-1276.421,-381.7636;Inherit;False;Property;_ColorTextureInfluence;Color Texture Influence;9;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-1405.701,436.8973;Inherit;False;Property;_ShapeTextureInfluence;Shape Texture Influence;8;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;1;0;1;FLOAT;0
...
WireConnection;165;1;194;0
WireConnection;19;0;11;0
WireConnection;19;1;195;0
...
ASEEND*/
//CHKSM=28303AC9E7E72CAA1DFCB60506DCBBF96B8B2CB7