...
Shader "TextureSlideShader"
{
	Properties
	{
		...
		_TexturePosition("TexturePosition", Range( 0 , 1)) = 0
	...
	LOD 0
		...
		Pass
		{
			...
			uniform float _TexturePosition;
				...
				) : SV_Target
			{
				...
				float4 appendResult55 = (float4(( _TexturePosition * -1.0 ) , ( ( 1.0 - temp_output_72_0 ) / ( temp_output_72_0 * 2.0 ) ) , 0.0 , 0.0));
				...
				float4 tex2DNode15 = tex2D( _Texture, ( float4( texCoord56, 0.0 , 0.0 ) * appendResult73 ).xy );
				
				float2 texCoord27 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_42_0 = ( texCoord27.x * temp_output_71_0 );
				float temp_output_81_0 = ( temp_output_71_0 * _TexturePosition );
				float temp_output_47_0 = ( ( 1.0 / temp_output_72_0 ) / 2.0 );
				...
				o.Smoothness = 0;
				o.Occlusion = 1;
				o.Alpha = ( tex2DNode15.r * ( ( ( temp_output_42_0 < ( 1.0 + temp_output_81_0 ) ? 1.0 : 0.0 ) * ( temp_output_42_0 > temp_output_81_0 ? 1.0 : 0.0 ) ) * ( ( texCoord27.y > ( 0.5 - temp_output_47_0 ) ? 1.0 : 0.0 ) * ( texCoord27.y > ( 0.5 + temp_output_47_0 ) ? 0.0 : 1.0 ) ) ) );
...
Node;AmplifyShaderEditor.CommentaryNode;65;-1488.539,392.4249;Inherit;False;1830.797;1027.172;Alpha filter to only display the tiled texture zone;15;81;27;79;77;76;32;50;33;49;46;48;45;47;42;38;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;93.29199,590.2088;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;52;386.6834,235.9029;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;10;-535.6299,134.4247;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;474d7a3eb26e4c14e930390837517da4;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-796.1414,-15.73979;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;15;-269.7562,-41.89386;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;-727.1882,444.2919;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;47;-1003.557,1086.585;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;45;-1171.77,1086.716;Inherit;False;2;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;48;-817.4818,1066.002;Inherit;False;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;46;-813.8395,1181.739;Inherit;False;2;2;0;FLOAT;0.5;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;49;-458.7362,1156.76;Inherit;True;2;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;33;-466.92,923.4749;Inherit;True;2;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;1;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;-186.389,1035.745;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;32;-446.6559,440.3756;Inherit;True;4;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;1;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;76;-692.0958,553.8227;Inherit;False;2;2;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;77;-444.5927,664.4782;Inherit;True;2;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;1;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;79;-152.0024,592.9078;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;81;-884.2992,578.6035;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;27;-1420.45,562.5708;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;74;-2330.823,892.9987;Inherit;False;Property;_TexturePosition;TexturePosition;3;0;Create;True;0;0;0;False;0;False;0;0.374713;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-2757.331,330.5825;Inherit;False;Property;_TextureWidth;TextureWidth;2;0;Create;True;0;0;0;False;0;False;0.4;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;73;-2327.651,362.3354;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
WireConnection;19;0;15;0
WireConnection;19;7;52;0
...
ASEEND*/
//CHKSM=0EB6F083A5D3B8E538C3D12402CFAF5161A3D1C0